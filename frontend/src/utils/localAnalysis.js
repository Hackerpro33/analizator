...
export function suggestDataApplications({ dataset = {}, project = {} } = {}) {
  ...
  if (hasLawEnforcement) {
    ...
    suggestions.push(
      "Используйте counterfactual анализ и Synthetic Control для создания \"синтетических двойников\" районов и более точной оценки эффективности пилотных мер безопасности."
    );
    suggestions.push(
